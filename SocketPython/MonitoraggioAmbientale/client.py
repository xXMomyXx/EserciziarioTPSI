...
if __name__ == "__main__":
    ...
    entry.pack(pady=5)
    button = tk.Button(start_window, text="Conferma", command=getNumDays)
    button.pack(pady=10)
    ...
    entry3.pack(pady=5)
    button1 = tk.Button(root, text="Invia dati", command=mainInterfaceLogic)
    button1.pack(pady=10)
    root.mainloop()

# Da aggiungere funzionamento con for loop per visualizzare la GUI il numero
# di giorni necessario e salvare i dati formattati come message nella lista daysData(ancora da dichiarare come lista)
